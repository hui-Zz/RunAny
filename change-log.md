...
- ##### ✅新增【RunAny无路径缓存机制】
  ...
  - 2020年前的老用户，如果没有生成无路径缓存，请在设置-搜索Everything-选择`按需搜索模式`
  - **当RunAny启动时Everything已经启动，无路径缓存会全部生成一遍，去除多余和更新最新版本的同名exe**
...
## 【RunAny】v5.6.1 ~ v5.6.5 2019-09-01
+ [✅便利新功能]
  + 热字符串生效前增加自动联想提示
...
## 【RunAny】v5.5.5~v5.5.7 外接插件脚本函数 2018-11-28
+ ##### 欢迎各位体验各种便捷的功能😄
