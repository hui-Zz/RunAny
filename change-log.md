...
## 【RunAny】5.8.2 2022.05.21

✅菜单项编辑 添加管理员权限运行勾选框
✅增加了所有菜单项的窗口，便于查看有哪些菜单项和全局热键（目前在右键任务栏托盘菜单里，后续可能会移动位置）
✅增加高级配置：对选中的文字中有双百分号内容%%自动转换成变量值 （默认关闭）
🎨状态栏直观实时显示菜单项编辑结果
✨GUI窗口代码分离移动至底部（为后续重构代码做准备）

## 【RunAny】5.8.1 自定义一键直达 2022.03.31
...
## 【RunAny】v5.7.4 右键打开多功能菜单 2021-01-15
+ `✅新增` RunAny设置：
  + 插件管理独立脚本一键暂停、挂起、关闭
