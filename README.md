...
- ✅ [一键直达](/README?id=一键直达) <font color="red"><b>全新升级正则直达！</b></font>，[一键公式计算](/README?id=一键公式计算)，[一键批量搜索](/README?id=批量搜索)
...
如：bilibili的BV号跳转、IP地址选中一键ping、23位字母（1qxbYAx0UA-u1dkoY-RXZJg）一键跳转百度云  
